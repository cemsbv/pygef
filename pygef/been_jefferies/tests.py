...
class BeenJeffreyTest(unittest.TestCase):
    ...
    def test_excess_pore_pressure_ratio(self):
        ...
        df = pd.DataFrame({'soil_pressure': [0.002, 0.003, 0.004],
                            'qt': [1, 1, 1],
                            'water_pressure': [0.0049050000000000005, 0.009810000000000001, 0.014715],
                            'u2': [0.002, 0.002, 0.002],
                            'excess_pore_pressure_ratio': [-0.002910821643286574, -0.007833500501504515, -0.012766064257028113]})
        assert_frame_equal(v, df)
    ...
    def test_ic_to_soil_type(self):
        ...
        df = pd.DataFrame({'type_index': [2.208177, 2.408926, 2.793642],
                           ...
                           'soil_type': ['Silty sand to sandy silt','Clayey silt to silty clay', 'Clays']})
        assert_frame_equal(v, df)
    ...
    def test_been_jeffrey(self):
        ...
        df = pd.DataFrame({'qc': [1, 1, 1],
                           ...
                           'excess_pore_pressure_ratio': [-0.0029050000000000005, -0.007880928355196772, -0.01294806517311609],
    ...
    def test_iterate_been_jeffrey(self):
        ...
        df = pd.DataFrame({'qc': [1, 1, 1],
                           ...
                           'excess_pore_pressure_ratio': [-0.0029050000000000005, -0.007853192559074913,
